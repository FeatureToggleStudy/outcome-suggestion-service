...
var threshold = parseFloat(process.env.CLARK_LO_SUGGESTION_THRESHOLD);
var ExpressRouteDriver = /** @class */ (function () {
    function ExpressRouteDriver(dataStore) {
        this.dataStore = dataStore;
        this._SuggestionInteractor = new interactors_1.SuggestionInteractor(dataStore);
    }
    ...
    ExpressRouteDriver.prototype.setRoutes = function (router) {
        var _this = this;
        router.post('/suggestOutcomes', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var text, filter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._SuggestionInteractor.suggestOutcomes(text, 'text', threshold, filter)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
